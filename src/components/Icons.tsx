// SVG Icon components — all sourced from the provided asset package
// No external icon libraries used

export const IconArrowPath = ({ className = "" }: { className?: string }) => (
...
export const IconArrowTrendingUp = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
    <path fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"
...
export const IconChevronUpSolid = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} aria-hidden="true">
...
export const IconCube = ({ className = "" }: { className?: string }) => (
...
export const IconLinkSolid = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className} aria-hidden="true">
    <path fill="currentColor" fillRule="evenodd"
...
// NexusAI Logo mark — brand colors: Forsythia + Nocturnal Expedition
export const IconNexusLogo = ({ className = "" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 36" fill="none" className={className} aria-label="NexusAI Logo">
    <defs>
    ...
    {/* Hex background */}
    <path d="M18 2L32 10V26L18 34L4 26V10L18 2Z" fill="url(#logoTeal)" stroke="rgba(255,200,1,0.3)" strokeWidth="1"/>
    {/* N letterform in gold */}
    <path d="M11 25V11L18 21V11M25 11V25" stroke="url(#logoGold)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    {/* Accent dot */}
    <circle cx="25" cy="25" r="2" fill="#FFC801"/>
  </svg>
);
...
// Minus icon for pricing (not included)
